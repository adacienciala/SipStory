...
<kod_projektu>
Wez pod uwagę cały #codebase, szczegolnie pliki w folderze #file:../../src
</kod_projektu>
...
Twoim zadaniem jest wygenerowanie szczegółowego planu testów, który będzie dostosowany do specyfiki projektu, uwzględniając wykorzystywane technologie, strukturę kodu oraz kluczowe elementy repozytorium. Plan testów powinien być napisany w języku angielskim.
...
Przedstaw ten plan w formacie Markdown i zapisz do pliku o nazwie "test-plan.md" w folderze #file:../../.ai
