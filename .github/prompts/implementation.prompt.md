...
<implementation_plan>
{{endpoint implementation plan file given by user}}
</implementation_plan>
...
4. Testing considerations:
   ...
   - Do not implement testing. Only create the testing script in #file:../../api-tests-scripts/ as test-[endpoint-name].http.
   - The testing script should include basic: happy path tests, edge cases, and error cases. Do not create exhaustive tests. It should be maximum 10-15 tests, depending on complexity of the endpoint.
