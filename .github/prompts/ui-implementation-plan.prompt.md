...
3. User Stories:
   <user_stories>
   {{user stories given by user}}
   </user_stories>

4. Endpoint Description:
   <endpoint_description>
   {{endpoints descriptions given by user}}
   </endpoint_description>

5. Endpoint Implementation:
   <endpoint_implementation>
   {{endpoints given by user}}
   </endpoint_implementation>
...
The final output should be in English and saved in a file named .ai/ui/{view-name}-view-implementation-plan.md. Do not include any analysis and planning in the final output.
