...
/**
 * GET /api/brands
 * Retrieves a paginated list of all brands with optional search and pagination
...
export const GET: APIRoute = async ({ request, locals }) => {
  try {
    ...
    const validationResult = brandsQuerySchema.safeParse({
      page: pageParam,
      limit: limitParam,
    ...
    const result = await listBrands(supabase, validationResult.data);
